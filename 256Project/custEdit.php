...
if(!empty($_POST) && isset($_POST["oldPass"]) && isset($_POST["newPass"])){
  ...
  if(checkUserPassword($user["email"], $oldPass)){
...
if(!empty($_POST) && isset($email) && isset($username) && isset($city) && isset($district) && isset($address)){
  updateUser($email, $username, $city, $district, $address);
  
  checkUser($email, $user["password"], $user);
  $_SESSION["user"]=$user;
    ...
    <div class="midBox">
      ...
      <form action="" method="post">
        ...
        <div class="form-group" style="display: flex; justify-content: space-between;">
          ...
          <a href="custMain.php" class="button" title="edit">Back</a>
        </div>
      </form>
    </div>
    ...
    <div class="midBox">
      ...
      <form action="" method="post">
        <div class="form-group">
          ...
          <input type="text" name="oldPass" id="">
        </div>
